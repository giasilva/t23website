import type { Graphics } from '../../graphics/lib';
/**
 ...
 */
export declare function drawTorus(this: Graphics, x: number, y: number, innerRadius: number, outerRadius: number, startArc?: number, endArc?: number): Graphics;
